//! flong sweeper (DESIGN.md, "Files"): launcher/flong-sweeper.c, line by
//! line (:18-42). The C was deleted in phase 5 (b), and its line numbers
//! here are those of c9571be. `main` is the subcommand's, which
//! src/main.zig calls.
//!
